...
**Result (real data, 48 GR tasks, 10 generations, 10 LLM calls):**
...
honest realisation of the paper's "behavior-specific penalties / preferences"
future-work direction. (The GA remains the default: reproducible and fast.)
...
| Horizon | Tasks | No-grouping | Paper ILP | **Multi-agent** |
|---|---|---|---|---|
...
- **The multi-agent keeps the violation count at 0 at every horizon**, i.e. it
  never lets a unit drop below the 3.0 bar threshold, even as it pushes
...
for GIS data), we validated it on a canonical, widely-cited public benchmark:
...
*Generated by the AgentOpt project. All numbers come from code run on real PSEM
data and the public Solomon C101 dataset.*